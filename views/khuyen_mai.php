...
<head>
	...
	<link rel="stylesheet"
		href="../templates/glowing-bootstrap-5/assets/vendors/lightgallery/css/lightgallery-bundle.min.css">
	...
	<link rel="stylesheet"
		href="../templates/glowing-bootstrap-5/assets/vendors/fonts/a-antara-distance/stylesheet.min.css">
			...
			<div class="col-lg-12">
				<ul class="list-unstyled mb-0 " style="display:flex; justify-content: space-between; flex-wrap:wrap;">
					...
					<?php foreach ($khuyenmai as $khuyenmais): ?>
						<li class="mb-4" style="width: 1500px; height: 220px; overflow: hidden; margin-bottom: 20px;">
							<div class="card border-0 flex-row">
								...
								<figure class="flex-shrink-0 mb-0 me-3">
									<button class="btn" style="padding: unset; width: 100px;" onclick="copyToClipboard('<?= $khuyenmais['ma_khuyen_mai'] ?>')">Sao chép</button>
								</figure>
							</div>
						</li>
					<?php endforeach; ?>
...
<script>
	function copyToClipboard(voucherCode) {
		// Tạo một phần tử input tạm thời để chứa mã voucher
		...
		// Chọn và sao chép giá trị từ input
		tempInput.select();
...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/blog/classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 12:24:38 GMT -->
