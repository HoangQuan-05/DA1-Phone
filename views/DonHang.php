    ...
    <main id="content" class="wrapper layout-page">
        ...
        <section class="container">
            <div class="shopping-cart">
                <h2 class="text-center fs-2 mt-12 mb-13">Đơn hàng</h2>
                <form class="table-responsive-md pb-8 pb-lg-10" method="GET">
                        ...
                        <tbody>
                            <?php foreach ($data as $value) : ?>
                                <tr class="position-relative">
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">
                                        <a href="index.php?act=don_hang_chi_tiet&id=<?= $value['id_hoa_don'] ?>" class="d-block text-secondary">
                                            Xem chi tiết
                                        </a>
                                    </td>
                                </tr>
