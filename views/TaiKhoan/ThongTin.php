                    ...
                    <div class="sticky-area border-right">
                        ...
                        <div class="collapse navbar-collapse bg-body position-relative z-index-5" id="primaryMenuSidebar">
                            ...
                            <ul class="list-group list-group-flush list-group-no-border w-100 p-6">
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 has-children border-0">
                                    ...
                                    <div class="collapse menu-collapse" id="sellers">
                                        <ul class="sub-menu list-unstyled">
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                                    href="sellers-profile.html" title="Sellers Profile">Sellers Profile</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 has-children border-0">
                                    ...
                                    <div class="collapse menu-collapse" id="account">
                                        <ul class="sub-menu list-unstyled">
                                            ...
                                            <li class="sidebar-item">
                                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                                    href="../user-registration.html" title="User registration">User registration</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                    <a href="reviews.html"
                                        class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Reivews">
                                        <span class="sidebar-item-icon w-40px d-inline-block text-muted">
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                    <a href="brands.html"
                                        class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Brand">
                                        <span class="sidebar-item-icon w-40px d-inline-block text-muted">
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 has-children border-0">
                                    ...
                                    <div class="collapse menu-collapse" id="setting">
                                        <ul class="sub-menu list-unstyled">
                                            <li class="sidebar-item">
                                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                                    href="profile-settings.html" title="Profile settings">Profile settings</a>
                                            </li>
                                            <li class="sidebar-item">
                                                <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                    <a href="starter-page.html"
                                        class="text-heading text-decoration-none lh-1 sidebar-link py-5 px-6 d-flex align-items-center" title="Starter page">
                                        <span class="sidebar-item-icon w-40px d-inline-block text-muted">
                        ...
                        <nav class="navbar navbar-light py-0 row no-gutters px-3 px-lg-0">
                            <div class="col-md-4 px-0 px-md-6 order-1 order-md-0">
                                <form>
                                    <div class="input-group position-relative bg-input rounded">
                                        <input type="text"
                                            class="form-control border-1 pl-4 shadow-none"
                                            placeholder="Search Item">
                            ...
                            <div class="col-md-6 d-flex flex-wrap justify-content-md-end align-items-center order-0 order-md-1">
                                ...
                                <div class="dropdown no-caret px-4 mx-3 py-2">
                                    <a href="#" class="dropdown-toggle fs-5 text-decoration-none fw-500 lh-1 animation-shake position-relative"
                                        data-bs-toggle="dropdown">
                                        <i class="far fa-bell"></i>
                                ...
                                <div class="dropdown px-4 mx-3 py-2 dropdown-language">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item text-brand" href="#"><img src="../assets/images/dashboard/flag-us.png"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <aside class="col-lg-4">
                                                        <div class="text-lg-center">
                                                            <div class="mx-auto">
                                                                <img class="mb-9 rounded-pill lazy-image" src="#" data-src="../assets//images/dashboard/avatar-1.png" alt="User Photo" height="196" width="196">
                                                            </div>
                                                            <div>
...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/dashboard/profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 12:24:51 GMT -->
