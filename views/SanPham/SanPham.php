				...
				<div class="container">
					<nav class="py-4 lh-30px" aria-label="breadcrumb">
						<ol class="breadcrumb justify-content-center py-1">
							<li class="breadcrumb-item"><a href="index.php?act=/">Trang chủ</a></li>
				...
				<aside class="primary-sidebar ">
					...
					<div class="widget widget-product-price">
						...
						<ul class="navbar-nav navbar-nav-cate" id="widget_product_price">
							<li class="nav-item">
								<a href="index.php?act=san_pham&page=1" title="All"
									class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">Tất cả</span></a>
							</li>
							<li class="nav-item">
								<a href="index.php?act=san_pham&gia=min&by=ASC"
									class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">Thấp nhất</span></a>
							</li>
							<li class="nav-item">
								<a href="index.php?act=san_pham&gia=max&by=DESC"
									class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline">Cao nhất</span></a>
							</li>
							<li class="nav-item">
								<form action="" method="GET">
									<input type="hidden" name="act" value="san_pham">
									<p class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center">
					...
					<div class="widget widget-product-size">
						...
						<ul class="navbar-nav navbar-nav-cate" id="widget_product_size">
							...
							<?php foreach ($danh_muc as $dm) : ?>
								...
								<li class="nav-item">
									<a href="index.php?act=san_pham&danh_muc=<?= $dm['ten_danh_muc'] ?>"
										class="text-reset position-relative d-block text-decoration-none text-body-emphasis-hover d-flex align-items-center"><span class="text-hover-underline"><?= $dm['ten_danh_muc'] ?></span></a>
								</li>
			...
			<div class="row gy-50px">
				...
				if (empty($_GET['min']) && empty($_GET['max']) && empty($_GET['gia']) && empty($_GET['danh_muc'])) : ?>
					...
					<nav class="d-flex mt-13 pt-3 justify-content-center" aria-label="pagination" data-animate="fadeInUp">
						<ul class="pagination m-0">
							<li class="page-item">
								<a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="index.php?act=san_pham&page=1" aria-label="Previous">
									<svg class="icon">
							...
							for ($i = 1; $i <= $page; $i++) : ?>
								...
								<?php else : ?>
									<li class="page-item"><a class="page-link" href="index.php?act=san_pham&page=<?= $i ?>"><?= $i ?></a></li>
								<?php endif; ?>
							<?php endfor ?>
							<li class="page-item">
								<a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="index.php?act=san_pham&page=<?= $page ?>" aria-label="Next">
									<svg class="icon">
				...
				if (isset($_GET['danh_muc'])) : ?>
					...
					<nav class="d-flex mt-13 pt-3 justify-content-center" aria-label="pagination" data-animate="fadeInUp">
						<ul class="pagination m-0">
							<li class="page-item">
								<a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="index.php?act=san_pham&danh_muc=<?= $_GET['danh_muc'] ?>&page=1" aria-label="Previous">
									<svg class="icon">
										<use xlink:href="#icon-angle-double-left"></use>
									</svg>
								</a>
							...
							for ($i = 1; $i <= $page; $i++) : ?>
								...
								<?php else : ?>
									<li class="page-item"><a class="page-link" href="index.php?act=san_pham&danh_muc=<?= $_GET['danh_muc'] ?>&page=<?= $i ?>"><?= $i ?></a></li>
								<?php endif; ?>
							<?php endfor ?>
							<li class="page-item">
								<a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="index.php?act=san_pham&danh_muc=<?= $_GET['danh_muc'] ?>&page=<?= $page ?>" aria-label="Next">
									<svg class="icon">
										<use xlink:href="#icon-angle-double-right"></use>
									</svg>
								</a>
				...
				<?php if (isset($_GET['min'], $_GET['max']) && $_GET['min'] !== "" && $_GET['max'] !== "") :
					...
					foreach ($san_pham as $value) :
						if ($min <= $value['gia_ban'] && $value['gia_ban'] <= $max) : ?>
				...
				<!-- SẢN PHẨM MIN, MAX 2.0 -->


				<?php if (((isset($_GET['min']) && empty($_GET['max']) && $_GET['max'] == "") || (isset($_GET['max']) && empty($_GET['min']) && $_GET['min'] == "")) && $stt) : ?>
					<?php
