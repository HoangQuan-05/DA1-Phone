                        ...
                        <div class="row">
                            <div class="col-xl-2 pe-xl-0 order-1 order-xl-0 mt-5 mt-xl-0">
                                <div id="slide-thumb-5" class="slick-slider slick-slider-thumb ps-1 ms-n3 me-n4 mx-xl-0" data-slick-options='{&#34;arrows&#34;:false,&#34;asNavFor&#34;:&#34;#slide-5&#34;,&#34;dots&#34;:false,&#34;focusOnSelect&#34;:true,&#34;responsive&#34;:[{&#34;breakpoint&#34;:1260,&#34;settings&#34;:{&#34;vertical&#34;:false}}],&#34;slidesToShow&#34;:4,&#34;vertical&#34;:true}'>
                                    ...
                                    <img src="#" data-src="../assets/images/shop/product-gallery-02-154x205.jpg" class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7" width="540" height="720" alt="">
                                    <img src="#" data-src="../assets/images/shop/product-gallery-03-154x205.jpg" class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7" width="540" height="720" alt="">
                                    <img src="#" data-src="../assets/images/shop/product-gallery-04-154x205.jpg" class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7" width="540" height="720" alt="">
                                </div>
                            </div>
                            <div class="col-xl-10 ps-xl-8 pe-xl-0 order-0 order-xl-1">
                                <div class="position-relative">
                                    <div class="position-absolute z-index-2 w-100 d-flex justify-content-end">
                                        <div class="p-6">
                                            ...
                                            <a href="https://www.youtube.com/watch?v=6v2L2UGZJAM" class="view-video d-flex align-items-center justify-content-center mt-5 product-gallery-action rounded-circle" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Play Video">
                                                <svg class="icon fs-4">
                                ...
                                <div id="slide-5" class="slick-slider slick-slider-arrow-inside slick-slider-dots-inside slick-slider-dots-light g-0" data-slick-options='{&#34;arrows&#34;:false,&#34;asNavFor&#34;:&#34;#slide-thumb-5&#34;,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1,&#34;vertical&#34;:true}'>
                                    <a href="../assets/images/shop/product-gallery-01.jpg" data-gallery="gallery5" data-thumb-src="../assets/images/shop/product-gallery-01.jpg"><img src="#" data-src="../assets/images/shop/product-gallery-01.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                                    <a href="../assets/images/shop/product-gallery-02.jpg" data-gallery="gallery5" data-thumb-src="../assets/images/shop/product-gallery-02.jpg"><img src="#" data-src="../assets/images/shop/product-gallery-02.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                                    <a href="../assets/images/shop/product-gallery-03.jpg" data-gallery="gallery5" data-thumb-src="../assets/images/shop/product-gallery-03.jpg"><img src="#" data-src="../assets/images/shop/product-gallery-03.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                                    <a href="../assets/images/shop/product-gallery-04.jpg" data-gallery="gallery5" data-thumb-src="../assets/images/shop/product-gallery-04.jpg"><img src="#" data-src="../assets/images/shop/product-gallery-04.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 pt-md-0 pt-10">
                    ...
                    <form class="pb-8">
                        ...
                        <div class="form-group product-color mb-7 mt-3">
                            <label class="mb-2 pb-4"><span class="fw-semibold text-body-emphasis me-2 pe-4">Color:</span> <span>Green - Revitalizing</span></label>
                            <ul class="list-inline d-flex justify-content-start mb-0">
                                <li class="list-inline-item list-color-product selected p-3">
                                    <a href="#" class="d-block color-item green-revitalizing"></a>
                                </li>
                                <li class="list-inline-item list-color-product p-3">
                                    <a href="#" class="d-block color-item pink"></a>
                                </li>
                                <li class="list-inline-item list-color-product p-3">
                                    <a href="#" class="d-block color-item green"></a>
                                </li>
                                <li class="list-inline-item list-color-product p-3">
                                    <a href="#" class="d-block color-item purple"></a>
                                </li>
                            </ul>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                <div class="pt-8 pb-3">
                                    ...
                                    <ul class="ps-6 mb-8">
                                        <li class="mb-3">Read the label. Follow all directions and heed all warnings.
                                        </li>
                                        <li class="mb-3">Wash your hands before you use the product.</li>
                                        <li class="mb-3">Do not share makeup.</li>
                                        <li class="mb-3">Keep the containers clean and tightly closed when not in use,
                                            and protect them from temperature extremes.
                                        </li>
                                        <li class="mb-3">Throw away cosmetics if there are changes in color or smell.
                                        </li>
                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end py-5 ps-5 pe-0">Nannochloropsis Oculata (micro algae)
                                                        extract, pullulan
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0 py-5 pe-5 text-body-emphasis">Composition</td>
                                                    <td class="text-end py-5 ps-5 pe-0">Nannochloropsis Oculata (micro algae)
                                                        extract, pullulan, water, ethanol
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0 py-5 pe-5 text-body-emphasis">Appearance</td>
                                                    <td class="text-end py-5 ps-5 pe-0">Yellow to amber, viscous liquid</td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0 py-5 pe-5 text-body-emphasis">Solubility</td>
                                                    <td class="text-end py-5 ps-5 pe-0">Soluble in water &amp; ethanol</td>
                                                </tr>
                                                <tr>
                                                    <td class="ps-0 py-5 pe-5 text-body-emphasis">Storage</td>
                                                    <td class="text-end py-5 ps-5 pe-0">Store refrigerated (4-8oC / 39-46oF)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
