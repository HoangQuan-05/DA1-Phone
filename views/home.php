...
<!-- Mirrored from templates/glowing-bootstrap-5/home-16.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 12:22:53 GMT -->
<!-- Added by HTTrack -->
...
<body>
		...
		<div class="sticky-area">
			<div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
				<div class="container-fluid px-10 px-xl-21 px-lg-15 flex-nowrap">
					...
					<a href="index.html" class="navbar-brand py-4 mx-auto w-xl-50">
				...
				<div class="row g-8">
					<div class="col-12 col-lg-8 mb-md-0" data-animate="fadeInUp">
						<div class="border-0 text-center hero-hover-shine hero-hover hero-power-1">
							<div data-bg-src="assets/images/hero-slider/hero-slider-39.jpg"
						...
						<div class="row g-sm-8 g-lg-0 h-100">
							<div class="col-12 col-sm-6 col-lg-12 h-auto" data-animate="fadeInUp">
								<div class="border-0 text-center hero-hover-shine hero-hover h-100">
									...
									<div class="lazy-bg bg-overlay card-img hero-hover-item bg-image h-100   light-mode-img"
										data-bg-src="assets/images/hero-slider/hero-slider-40.jpg">
									</div>
									<div class="lazy-bg bg-overlay dark-mode-img card-img hero-hover-item bg-image h-100"
										data-bg-src="assets/images/hero-slider/hero-slider-white-40.jpg">
									</div>
									<div class="card-img-overlay p-14 align-items-center d-flex justify-content-center">

										<div class="hero-content">
											<div data-animate="fadeInDown">
											</div>
											<a href="#" data-animate="fadeInUp"
												class="btn btn-white px-10  shadow-sm z-index-1">
												Haircare
											</a>
										</div>
									</div>
							...
							<div class="col-12 col-sm-6 col-lg-12 h-auto mt-8 mt-lg-8" data-animate="fadeInUp">
								<div class="border-0 text-center hero-hover-shine hero-hover h-100">
									...
									<div class="lazy-bg bg-overlay card-img hero-hover-item bg-image h-100   light-mode-img"
										data-bg-src="assets/images/hero-slider/hero-slider-41.jpg">
									</div>
									<div class="lazy-bg bg-overlay dark-mode-img card-img hero-hover-item bg-image h-100"
										data-bg-src="assets/images/hero-slider/hero-slider-white-41.jpg">
									</div>
									<div class="card-img-overlay p-14 align-items-center d-flex justify-content-center">
		...
		<section>
			<div class="container pt-12 pb-lg-16 pb-16">
				<div class="text-center position-relative pt-12 pt-lg-17 pb-11 pb-lg-14 mx-auto" style="max-width:700px"
					...
					<p
						class="fs-80px fw-normal fs-sm-90px fs-md-142px text-custom-1 font-primary lh-1 top-0 position-absolute w-100 z-index-1">
						Phone Plus</p>
					<p class="position-relative z-index-2 fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">Smartphone
					</p>
					<h2 class="mb-4 position-relative z-index-2">Công nghệ mới, giá cực chất!
					</h2>
				</div>
				<div class="row gy-8">
						...
						<div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									...
									<img src="#" data-src="./assets/images/products/product-11-270x360.jpg"
						...
						<div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									...
									<img src="#" data-src="./assets/images/products/product-02-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Perfecting Facial Oil" width="270"
										height="360">
								</a>
						...
						<div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									...
									<img src="#" data-src="./assets/images/products/product-15-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Shield Shampoo" width="270"
										height="360">
								</a>
							...
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									...
									<img src="#" data-src="./assets/images/products/product-07-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Enriched Hand Wash" width="270"
										height="360">
								</a>
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									title="Enriched Duo">
									<img src="#" data-src="./assets/images/products/product-08-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Enriched Duo" width="270" height="360">
								</a>
							...
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									...
									<img src="#" data-src="./assets/images/products/product-06-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Shield Spray" width="270" height="360">
								</a>
					...
					<div class="col-lg-3 col-sm-6 col-12">
						<div class="card card-product grid-2 bg-transparent border-0" data-animate="fadeInUp">
							<figure class="card-img-top position-relative mb-7 overflow-hidden">
								<a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
									title="Shield Spray">
									<img src="#" data-src="./assets/images/products/product-09-270x360.jpg"
										class="img-fluid lazy-image w-100" alt="Shield Spray" width="270" height="360">
								</a>
				...
				<div class="text-center mt-12">
					<a href="#" target="_blank" class="btn btn-outline-dark" data-animate="fadeInUp">
						Shop All Product
					</a>
				</div>
			</div>
				...
				<div class="row gy-30px gx-30px">
					<div class="col-12 col-lg-5" data-animate="fadeInUp">
						<div class="card border-0 rounded-0 banner-09" data-bs-theme="light"><img
								...
								src="assets/images/banner/banner-48.jpg" alt="25% off Everything">
							<div class="card-img-overlay d-inline-flex flex-column ps-md-13 pt-md-15 px-10 py-15">
								<h3 class="card-title lh-52px fw-semibold mw-xl-60 mw-lg-0 w-md-80 mb-7 fs-42px">25% off
									Everything</h3>
					...
					<div class="col-12 col-lg-7" data-animate="fadeInUp">
						<div class="card border-0 rounded-0 banner-06 hover-zoom-in hover-shine">
							...
							<img class="lazy-image w-100 card-img object-fit-cover  light-mode-img" src="#"
								data-src="./assets/images/banner/banner-46.jpg" width="690" height="450" alt="">
							<img class="lazy-image dark-mode-img w-100 card-img object-fit-cover " src="#"
								data-src="./assets/images/banner/banner-white-46.jpg" width="690" height="450" alt="">
			...
			<div class="container text-center mt-lg-3">
				<div class="row">
					<div class="col-lg-6 border-0 border-lg-end" data-animate="fadeInUp">
						...
						<p class="mx-auto mb-10 newletter-follow-desc"> Shapes and proportions are for your intellect.
							I’ve treated the waistcoat as if it were a corset.</p>
						<div class="socical-icon social-icon-style-1 ">
							<ul class="list-inline fs-5 mb-0">
								<li class="list-inline-item me-7 me-lg-12"><a href="#"><i
					...
					<div class="col-lg-6 mt-11 mt-lg-0" data-animate="fadeInUp">
						<h3 class="mx-auto fs-4 mb-6">Let’s Stay in Touch</h3>
	...
	<footer class="pt-14 pt-lg-20 pb-16 footer bg-body-tertiary">
		<div class="container pt-4">
			<div class="row">
				<div class="col-lg-5 col-12 mb-12 mb-lg-0">

					<h3 class="mb-6 ">PhonePlus</h3>
					<p class="pe-xl-23 mb-lg-11">Smartphone chính hãng – Dẫn đầu xu hướng.</p>
					<a class="fw-semibold fs-6 text-decoration-none"
						href="https://templates/find-a-store.html">
				...
				<div class="col-lg col-md-4 col-12 mb-12 mb-lg-0">
	...
	<div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
		...
		<div class="offcanvas-footer flex-wrap">
			...
			<a href="https://templates/shop/checkout.html" class="btn btn-dark w-100 mb-7"
				title="Check Out">Check Out</a>
			<a href="https://templates/shop/shopping-cart.html" class="btn btn-outline-dark w-100"
					...
					<li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
						...
						<div class="dropdown-menu mega-menu start-0 py-6 " aria-labelledby="menu-item-docs-canvas">
							<div class="menumega-docs px-8" style="min-width: 250px">
								...
								<a href="https://sp/" class="d-flex text-decoration-none mb-4 mb-lg-0"
